      ...
      body: Padding(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              SettingsSwitchWidget(text: "Assign", onChanged: (b) {}),
              const Divider(),
              SettingsSwitchWidget(text: "Comment", onChanged: (b) {}),
              const Divider(),
              SettingsSwitchWidget(text: "Follow", onChanged: (b) {}),
              const Divider(),
              SettingsSwitchWidget(text: "Notification", onChanged: (b) {}),
            ],
          ),
        ),
      ),
